...
public class ARContent : MonoBehaviour
{
    ...
    public void SetUpContent(HistoricStreet historicStreet)
    {
        ...
        {
            textMeshPro.text = $"{historicStreet.LocationName}\n\n{historicStreet.Textcontent}";
        }
    ...
    public HistoricStreet GetHistoricStreet()
    {
        return street;
    }

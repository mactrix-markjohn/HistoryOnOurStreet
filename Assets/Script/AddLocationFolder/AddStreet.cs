...
public class AddStreet : MonoBehaviour
{
    ...
    private UserLatLng sentUserLocation;
    ...
    void Start()
    {
        ...
        if ((AddStreetPopUpScript.currentLocation != null) && (AddStreetPopUpScript.clicked) )
        {
            sentUserLocation = AddStreetPopUpScript.currentLocation;

            Lat.text =  ""+sentUserLocation.LatLng.Lat;
            Lng.text = "" + sentUserLocation.LatLng.Lng;

            AddStreetPopUpScript.clicked = false; 
        }

        /*ApplicationChrome.statusBarState = ApplicationChrome.States.Visible;
        ApplicationChrome.statusBarColor = 0xffffffff;*/
